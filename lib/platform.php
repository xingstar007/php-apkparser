...
class PermissionList {
    ...
    public static $internal = array(
        ...
        "android.permission.READ_LOGS" => array(
            ...
            "description" => "Allows the app to read from the system's various log files.  This allows it to discover general information about what you are doing with the phone, potentially including personal or private information."
        ),
        ...
        "android.permission.WRITE_SECURE_SETTINGS" => array(
            ...
            "description" => "Allows the app to modify the system's secure settings data. Not for use by normal apps."
        ),
        ...
        "com.android.browser.permission.WRITE_HISTORY_BOOKMARKS" => array(
            ...
            "description" => "Allows the app to modify the Browser's history or bookmarks stored on your phone. This may allow the app to erase or modify Browser data.  Note: this permission may note be enforced by third-party browsers or other applications with web browsing capabilities."
        ),
